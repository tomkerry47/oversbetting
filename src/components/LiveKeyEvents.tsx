...
function TeamEvents({ events, align }: { events: any[]; align: 'left' | 'right' }) {
...
export default function LiveKeyEvents({ events = [] }: { events?: any[] }) {
